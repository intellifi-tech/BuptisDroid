...
namespace Buptis.Lokasyonlar.BanaYakin
{
    ...
    class BanaYakinRecyclerViewAdapter : RecyclerView.Adapter/*, ValueAnimator.IAnimatorUpdateListener*/
    {
        ...
        public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
        {
            ...
            if (Convert.ToInt32(item.rating) >= 10)
            {
        ...
        void GetLocationOtherInfo(BanaYakinRecyclerViewDataModel gelendto, int locid, List<string> catid,string townid,TextView LokasyonTuru,TextView UzaklikveSemt)
        {
