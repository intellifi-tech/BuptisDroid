...
{
    class IsteklerListViewAdapter : BaseAdapter<IsteklerListViewDataModel>, View.IOnClickListener
    {
        ...
        public IsteklerListViewAdapter(Context context, int rowLayout, List<IsteklerListViewDataModel> friends, List<string> FollowListID2)
        {
            mContext = context;
